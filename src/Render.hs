...
boardAsRunningPicture board = pictures
...
oCell :: Picture
oCell = thickCircle radius 10.0 where radius = min cellWidth cellHeight * 0.25
...
boardAsPicture board =
  pictures [xCellsOfBoard board, oCellsOfBoard board, boardGrid]
